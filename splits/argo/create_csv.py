...
for folder in folder_paths:
    ...
    for sub_folder in sub_folder_path:
        paths = os.listdir(os.path.join(dataset_dir, folder, sub_folder, "stereo_front_left"))
        print(sub_folder)

        for idx, image_path in enumerate(paths):

            full_img_path = os.path.join(dataset_dir, folder, sub_folder, "stereo_front_left", image_path)
            full_gt_path = os.path.join(dataset_dir, folder, sub_folder, "gt_top", image_path)
